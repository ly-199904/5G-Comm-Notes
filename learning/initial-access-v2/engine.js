/* ═══════════════════════════════════════════════════════════════════════════
   5G NR Initial Access · Engine v2.1
...
(function () {
    ...
    '<div class="dashboard" id="dashboard">' +
      '<div class="topbar">' +
        '<div class="topbar-left">' +
          ...
          '</div>' +
          '<span class="topbar-title">5G NR · 全流程交互仿真</span>' +
        '</div>' +
        '<div style="display:flex;flex-direction:column;gap:5px;">' +
          '<div class="tags-row">' +
            '<span class="env-tag static">FR1</span>' +
            '<span class="env-tag static">n78 · 3.5GHz</span>' +
            '<span class="env-tag static">Case C · 30kHz</span>' +
            '<span class="env-tag static">MIMO 2×4</span>' +
            '<span class="env-tag static">4-Step CBRA</span>' +
          '</div>' +
          '<div class="tags-row">' +
            '<span class="tags-sep"></span>' +
            '<span class="env-tag dynamic dim" id="dt-gscn">GSCN ···</span>' +
            '<span class="env-tag dynamic dim" id="dt-pci">PCI ···</span>' +
            '<span class="env-tag dynamic dim" id="dt-kssb">k_SSB ···</span>' +
            '<span class="env-tag dynamic dim" id="dt-bwp">BWP ···</span>' +
            '<span class="env-tag dynamic dim" id="dt-ta">TA ···</span>' +
        ...
        '<div class="info-panel">' +
          ...
          '<div class="console-wrapper">' +
            '<div class="console-header">' +
              ...
              '<span id="consoleSpec">UE BASEBAND L1 HARDWARE LOG</span>' +
            '</div>' +
  ...
  /* ── 顶部动态标签同步 ── */
  var _TAG_MAP = [
    { id:'dt-gscn',  key:'gscn',   fmt:function(v){ return 'GSCN '+v; } },
    { id:'dt-pci',   key:'pci',    fmt:function(v){ return 'PCI '+v;  } },
    { id:'dt-kssb',  key:'kssb',   fmt:function(v){ return 'k_SSB '+v;} },
    { id:'dt-bwp',   key:'initial_bwp_rb', fmt:function(v){ return 'BWP '+v+'RB';} },
    { id:'dt-ta',    key:'ta_ns',  fmt:function(v){ return 'TA '+v+'ns';} },
  ...
  function renderAll() {
    ...
    if(sm){
      ...
      if(cs&&sm.spec)cs.textContent='UE BASEBAND L1 LOG · '+sm.spec;
    }
    _syncCtxTags();
  ...
  function boot(config){
    ...
    LogEngine.clear();
    LogEngine.push('init','[CORE_SYS] 基带处理器 L1 固件安全加载完成。物理层状态机初始化。');
    var cf=flow();
